...
interface DesktopSystemModule : SystemModule {
    @Binds
    val AssetsDataSourceJvmImpl.bind: AssetsDataSource

    @Binds
    val ClipboardDataSourceJvmImpl.bind: ClipboardDataSource

    @Binds
    val FormattingDataSourceIcuImpl.bind: FormattingDataSource

    @Binds
    val IntentDataSourceDesktopImpl.bind: IntentDataSource

    @Binds
    val LocaleDataSourceJvmImpl.bind: LocaleDataSource
