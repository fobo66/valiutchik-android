...
public class BestCourse implements Parcelable {
    public String bank;
    ...
    public static final Creator<BestCourse> CREATOR = new Creator<BestCourse>() {
        @Override
        public BestCourse createFromParcel(Parcel in) {
            return new BestCourse(in);
        }

        @Override
        public BestCourse[] newArray(int size) {
    ...
    public boolean equals(Object o) {
        ...
        if (!currencyValue.equals(that.currencyValue)) return false;
