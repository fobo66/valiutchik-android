...
public class Currency {
    ...
    public Currency(String bankname, String usdBuy, String usdSell, String eurBuy, String eurSell, String rurBuy, String rurSell) {
    ...
    public boolean equals(Object o) {
        ...
        if (!bankname.equals(currency.bankname)) return false;
        if (!usdBuy.equals(currency.usdBuy)) return false;
        if (!usdSell.equals(currency.usdSell)) return false;
        if (!eurBuy.equals(currency.eurBuy)) return false;
        if (!eurSell.equals(currency.eurSell)) return false;
        if (!rurBuy.equals(currency.rurBuy)) return false;
