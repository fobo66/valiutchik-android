...
/**
 * XML parser for @link(myfin.by) feed
 * <p>
 * Created by fobo66 on 16.08.2015.
 */
public class MyfinXMLParser implements CurrencyCourseParser {
    private static final String ns = null;
    private final List<String> neededTagNames
            = new ArrayList<>(Arrays.asList("bankname", "usd_buy", "usd_sell", "eur_buy", "eur_sell", "rur_buy", "rur_sell"));
